...
DATA_DIR = os.getenv("DATA_DIR", "tensors_v6_targeted_recovery_v8")
MODEL_SAVE_PATH = os.getenv("MODEL_SAVE_PATH", "models/model_hybrid_v6_targeted_recovery_v8_latest_best.pt")
FINAL_MODEL_SAVE_PATH = os.getenv("FINAL_MODEL_SAVE_PATH", "models/model_hybrid_v6_targeted_recovery_v8_final.pt")
CHECKPOINT_DIR = os.getenv("CHECKPOINT_DIR", "models/checkpoints_v6_targeted_recovery_v8")
CHECKPOINT_PATH = os.path.join(CHECKPOINT_DIR, "latest.pt")
BASE_MODEL_PATH = os.getenv("BASE_MODEL_PATH", "models/model_hybrid_v6_mono_logo_v7_latest_best.pt")
